        ...
        <Main>
            ...
            <section>
                ...
                <section>
                    ...
                    <p>三角比の相互関係の公式の実例。公式①、②を使ってサインからコサイン、タンジェントを算出します。<br />
                    ※ただし、角度が90度〜270度(-270度〜-90度)の場合はコサインをマイナスにする必要があります。</p>
                    <figure><img src="img/sankaku_14.jpg" alt="sin -> cos, tan" /></figure>
                </section>
                <section>
                    <h3>コサインからサイン、タンジェントを算出</h3>
                    <p>三角比の相互関係の公式の実例。公式①、②を使ってコサインからサイン、タンジェントを算出します。<br />
                    ※ただし、角度が180度〜360度(0度〜-180度)の場合はサインをマイナスにする必要があります。</p>
                    <figure><img src="img/sankaku_15.jpg" alt="cos -> sin, tan" /></figure>
                </section>
                <section>
                    <h3>タンジェントからサイン、コサインを算出</h3>
                    <p>三角比の相互関係の公式の実例。公式①、③を使ってタンジェントからサイン、コサインを算出します。<br />
                    ※ただし、角度が90度〜270度(-270度〜-90度)の場合はコサインをマイナスにする必要があります。</p>
