        ...
        <Main>
            ...
            <section>
                ...
                <section>
                    ...
                    <p>三角関数から角度(ラジアン)を算出するJS関数。0〜90度まではどの関数も一致。それ以外の角度はatan2()が360度カバーでき、座標から直接算出できる意味でも一番良さそうです。</p>
                    <figure><img src="img/sankaku_17.jpg" alt="逆三角関数のJS関数" /></figure>
                    <p>atan2()は90〜180度でラジアンと一致する</p>
                    <figure><img src="img/sankaku_17_2.jpg" alt="逆三角関数のJS関数(0〜180度)" /></figure>
                    <p>atan2()は-180度〜0度でラジアンと一致する</p>
                    <figure><img src="img/sankaku_17_3.jpg" alt="逆三角関数のJS関数(-180度〜0度)" /></figure>
                    <ul>
